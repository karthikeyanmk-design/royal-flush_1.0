      ...
      <div className="mt-8 pt-6 border-t border-border">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <span className="text-2xl font-bold italic text-accent">Royal Flush</span>
            <span className="text-xs text-muted-foreground">© 2024 Royal Flush | All Rights Reserved</span>
          </div>
